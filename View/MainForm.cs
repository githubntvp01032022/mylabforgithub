    ...
    public partial class MainForm : Form
    {
       ...
       public MainForm()
       {
            ...
            dataGridView.Columns.AddRange(
                new DataGridViewTextBoxColumn() { Name = "Object", HeaderText = "Объект", DataPropertyName = "Object" },
                new DataGridViewTextBoxColumn() { Name = "S", HeaderText = "Сумма (S)", DataPropertyName = "S" },
                new DataGridViewTextBoxColumn() { Name = "I", HeaderText = "Параметр (I)", DataPropertyName = "I" }
                                         );
        }
